          ...
          <div class='facultyContainer'>
            ...
            <div class='facultyMainInfoContainer'>
              <div class='facultyUpperInfo'>
                <ul>
                  <li>
                    Education: <span class='UpperInfoData'>{d.education}</span>
                  </li>
                  <li>
                    Email-id: <span class='UpperInfoData'>{d.email}</span>
                  </li>
                  <li>
                    Contact: <span class='UpperInfoData'>{d.contact}</span>
                  </li>
                  <li>
                    Area of Interest: <span class='UpperInfoData'>Plastic Technology</span>
                  </li>
                </ul>
              </div>
              <div class='facultyLowerInfo'>
                <p>
                  Dr. J.S.P. Rai has completed his higher education from HBTI Kanpur where he served at various positions in his career. He
                  was Professor & Head at Department of Plastic Technology at HBTI Kanpur from 1994 onwards. He also worked as a Director at
                  HBTI Kanpur from 2011 to 2013.
                </p>
              </div>
            </div>
            <div class='facultyBriefButton'>
              <div class='BriefButton'>
                <Link to={`/faculty/profile/${d.id}`}>
                  <a>Brief Profile</a>
                </Link>
              </div>
            </div>
...
class FacultyDepartmentProfile extends React.PureComponent {
  ...
  render() {
    if (this.state.liveStatus) {
      return (
        <div>
          <h1 style={{ textAlign: "center" }}>Department of {this.state.whichDepartment}</h1>
          <hr />
